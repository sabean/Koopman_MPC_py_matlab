...
% figure
% NS=1000;
% plot([0:NS-1]*deltaT, X(1,1:NS),'-r','linewidth',2);
% grid on
% daspect([15 1 1])
...
% %%
% figure
% plot([0:NS-1]*deltaT, X(2,1:NS),'-r','linewidth',2);
% grid on
% daspect([4 1 1])
% xlabel('$t$',  'Interpreter', 'latex', 'FontSize',20)
...
% %%
% figure
% plot([0:NS-1]*deltaT, X(3,1:NS),'-r','linewidth',2);
% grid on
% daspect([4 1 1])
% xlabel('$t$',  'Interpreter', 'latex', 'FontSize',20)
...
% %%
% figure
% plot([0:NS-1]*deltaT, X(4,1:NS),'-r','linewidth',2);
% grid on
% daspect([1 1 1])
% xlabel('$t$',  'Interpreter', 'latex', 'FontSize',20)
...
% %%
% figure
% plot([0:NS-1], U(:,1:NS),'-b','linewidth',2);
% grid on
% daspect([500 1 1])
% xlabel('$t$',  'Interpreter', 'latex', 'FontSize',20)
...
%         RMSEE1 = RMSEE1 + norm(x_true(1,:) - xlift(1,:))/norm(x_true(1,:));
%         RMSEE2 = RMSEE2 + norm(x_true(3,:) - xlift(3,:))/norm(x_true(3,:));
%     end
%     RM1 = [RM1 RMSE1/100]
%     RM2 = [RM2 RMSE2/100]
...
p3=plot([0:Nsim-1]*deltaT,XX_koop(1,1:500),'-b','linewidth',lw_koop); hold on
...
%%
save('MPC_OPEN_POS','UU_koop','XX_koop', 'yrliftstack')
